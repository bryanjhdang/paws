...
export const RestCats: CatItem[] = [
  new CatItem(RestCat1, "Whiskers", 0),
  new CatItem(RestCat2, "Mochi", 100),
  new CatItem(RestCat3, "Nimbus", 200),
  new CatItem(RestCat4, "Tofu", 300),
]

//  Work Cats
export const WorkCats: CatItem[] = [
  new CatItem(WorkCat1, "Bubbles", 0),
  new CatItem(WorkCat2, "Pixie", 100),
  new CatItem(WorkCat3, "Snickers", 200),
  new CatItem(WorkCat4, "Frisbee", 300),
]
